...
type ComplexityRoot struct {
	...
	Query struct {
		GetAllComments      func(childComplexity int, input model.GetPostInput) int
...
type QueryResolver interface {
	...
	GetAllComments(ctx context.Context, input model.GetPostInput) ([]*model.Comment, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.getAllComments":
		...
		return e.complexity.Query.GetAllComments(childComplexity, args["input"].(model.GetPostInput)), true
	...
	case "Query.getPost":
		...
		return e.complexity.Query.GetPost(childComplexity, args["input"].(model.GetPostInput)), true
...
func (ec *executionContext) field_Query_getAllComments_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
		arg0, err = ec.unmarshalNGetPostInput2githubᚗcomᚋtipbkᚋdoodleᚋmodelᚐGetPostInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Query_getPost(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().GetPost(rctx, fc.Args["input"].(model.GetPostInput))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Query_getAllComments(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().GetAllComments(rctx, fc.Args["input"].(model.GetPostInput))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) unmarshalNGetPostInput2githubᚗcomᚋtipbkᚋdoodleᚋmodelᚐGetPostInput(ctx context.Context, v interface{}) (model.GetPostInput, error) {
